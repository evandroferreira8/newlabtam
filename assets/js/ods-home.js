(()=>{
  ...
  const ods=[
    {id:4,title:'Educação de Qualidade',symbol:'ED',color:'#c5192d',photo:'assets/images/ods/4.jpg',summary:'Assegurar a educação inclusiva, equitativa e de qualidade, promovendo oportunidades de aprendizagem ao longo da vida.',relation:'No LabTam, esse objetivo aparece na formação científica, na iniciação à pesquisa, na capacitação técnica e na divulgação do conhecimento produzido no laboratório.'},
    {id:5,title:'Igualdade de Gênero',symbol:'IG',color:'#ff3a21',photo:'assets/images/ods/5.jpg',summary:'Alcançar a igualdade de gênero e fortalecer a participação de meninas e mulheres em todos os espaços da sociedade.',relation:'A atuação do LabTam valoriza a presença feminina na ciência, na pesquisa aplicada, na liderança acadêmica e na construção de equipes diversas.'},
    {id:7,title:'Energia Limpa e Acessível',symbol:'EN',color:'#fcc30b',photo:'assets/images/ods/7.jpg',summary:'Garantir acesso confiável, sustentável, moderno e a preço acessível à energia para todas as pessoas.',relation:'As pesquisas do laboratório dialogam com soluções energéticas, hidrogênio, biomassa, materiais e processos voltados a tecnologias mais sustentáveis.'},
    {id:9,title:'Indústria, Inovação e Infraestrutura',symbol:'IN',color:'#fd6925',photo:'assets/images/ods/9.jpg',summary:'Construir infraestruturas resilientes, promover a industrialização inclusiva e sustentável e fomentar a inovação.',relation:'O LabTam contribui com desenvolvimento tecnológico, caracterização de materiais, infraestrutura analítica e aproximação entre universidade, setor produtivo e sociedade.'},
    {id:13,title:'Ação Contra a Mudança Global do Clima',symbol:'CL',color:'#3f7e44',photo:'assets/images/ods/13.jpg',summary:'Tomar medidas urgentes para combater a mudança do clima e seus impactos.',relation:'Projetos ligados a mitigação ambiental, captura de CO2, processos sustentáveis e redução de impactos climáticos se conectam diretamente a esse objetivo.'},
    {id:14,title:'Vida na Água',symbol:'VA',color:'#0a97d9',photo:'assets/images/ods/14.jpg',summary:'Conservar e usar de forma sustentável oceanos, mares e recursos marinhos para o desenvolvimento sustentável.',relation:'O ODS 14 se relaciona às pesquisas que apoiam monitoramento, conservação e proteção de ambientes aquáticos e recursos hídricos.'},
    {id:15,title:'Vida Terrestre',symbol:'VT',color:'#56c02b',photo:'assets/images/ods/15.jpg',summary:'Proteger, recuperar e promover o uso sustentável dos ecossistemas terrestres, combatendo a degradação ambiental.',relation:'O laboratório se conecta a esse objetivo por meio de estudos sobre sustentabilidade, biodiversidade, biomassa e redução de impactos em ecossistemas terrestres.'},
    {id:17,title:'Parcerias e Meios de Implementação',symbol:'PA',color:'#19486a',photo:'assets/images/ods/17.jpg',summary:'Fortalecer os meios de implementação e revitalizar parcerias para o desenvolvimento sustentável.',relation:'A atuação do LabTam depende de cooperação entre universidade, instituições públicas, empresas, comunidades, redes de pesquisa e parceiros estratégicos.'}
  ];
  const esc=(s)=>String(s).replace(/[&<>'"]/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;',"'":'&#39;','"':'&quot;'}[c]));
  function drawCards(){
    grid.innerHTML=ods.map((item,index)=>`<button class="ods-card${index===0?' active':''}" type="button" data-ods="${item.id}" aria-pressed="${index===0?'true':'false'}"><span class="ods-icon-tile"><span class="ods-icon-top"><span class="ods-card-number">${item.id}</span><small>Objetivo de Desenvolvimento Sustentável</small></span><span class="ods-symbol" aria-hidden="true">${esc(item.symbol)}</span><strong>${esc(item.title)}</strong></span></button>`).join('');
